...
### Tech Stack
| Frontend | Backend | Database & Integrations | Tools & Deployment |
|---|---|---|---|
| Next.js | TypeScript | MySQL | Git |
| React | JavaScript | MongoDB | GitHub |
| TypeScript | Python | Instagrapi | Docker |
| JavaScript | Node.js | Stripe | Vercel |
| Bootstrap | ExpressJS | SendGrid | Railway |
| Recharts.js | FastAPI | | Render |
| HTML | REST API | | |
| CSS | WebSockets | | |
| | Webhooks | | |
| | Rate Limiting | | |
